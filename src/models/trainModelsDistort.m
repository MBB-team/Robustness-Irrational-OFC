...
parfor i_network = 1:min(length(path_networks_distort), length(path_networks_target))
    ...
    out = performTraining(TrainingConfig, input_train, output_train, ...
        ...
        DatasetSpecs.CueDatasetTrain{TargetNetwork.seed}.i_step, train_all_params);
    ...
    [fit_train, fit_test, params] = testTrainingGeneralizability(out, ...
        ...
        DatasetSpecs.CueDatasetTrain{TargetNetwork.seed}.i_step, ...
        DatasetSpecs.CueDatasetTest{TargetNetwork.seed}.i_step, ...
        DistortNetwork.(distort_fit_label).params(:, end));
