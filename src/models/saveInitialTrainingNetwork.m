...
for i_fit = 1:length(fit_label)
    ...
    test_network = any(cellfun(@(x) ...
        (x.i_arch == Config.i_arch) && ...
        (x.input_label == Config.input_label) && ...
        (x.output_label == Config.output_label) && ...
        (x.output_format_label == Config.output_format_label), ...
        all_Config(i_select_configs)));
    if test_network
