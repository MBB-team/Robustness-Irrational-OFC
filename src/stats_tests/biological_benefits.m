...
Data.avg_prop_optimal_noise = mean(Data.prop_optimal_noise, 1);
...
for config_ID = 1:10
    ...
    % --- Compare tolerance to neural noise between rational and irrational models --- %

    group1 = Data.avg_prop_optimal_noise(select_config & Data.is_rational)';
    group1 = repmat(group1, 2, 1);
    group2 = Data.avg_prop_optimal_noise(select_config & Data.is_irrational)';
    stats_table = addPairedTtestStatsTableRow(stats_table, group1, group2, ...
        0.05 / 10, ...
        dependent_variable="avg_prop_optimal_noise", ...
        independent_variable="fit_phase", ...
        independent_variable_levels=["rational", "irrational"], ...
        subset_factors="model_config", ...
        subset_levels=config_ID);

    % --- Compare tolerance to neural noise between rational and irrational models (direct) --- %

    group1 = Data.avg_prop_optimal_noise(select_config & Data.is_rational)';
    group1 = repmat(group1, 2, 1);
    group2 = [...
        DataFranck.avg_prop_optimal_noise(...
        (DataFranck.config_ID == config_ID) & DataFranck.is_irrational)' ; ...
        DataMiles.avg_prop_optimal_noise(...
        (DataMiles.config_ID == config_ID) & DataMiles.is_irrational)'];
    stats_table = addPairedTtestStatsTableRow(stats_table, group1, group2, ...
        0.05 / 10, ...
        dependent_variable="avg_prop_optimal_noise", ...
