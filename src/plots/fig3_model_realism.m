...
% Subplots
plotValueProfile(nexttile(1, [1, 1]), MonkeyData.Franck.value_function, "Monkey F");
plotValueProfile(nexttile(2, [1, 1]), MonkeyData.Miles.value_function, "Monkey M");
...
cbar.Position = [...
    ...
    ax_middle_left.Position(2) - 0.038, ...
    cbar.Position(3), ...
    ax_top_left.Position(2) + ax_top_left.Position(4) - ax_middle_left.Position(2) + 0.09];
