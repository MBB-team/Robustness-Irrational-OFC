...
if ~ inlay_plot
    ...
    ghost_plots(13) = plot(ax, NaN, NaN, Marker=defineModelMarker(1), MarkerFaceColor="none", MarkerEdgeColor="k", LineStyle="none", LineWidth=plot_options.line_width, ...
        DisplayName="spatial");
    ghost_plots(14) = plot(ax, NaN, NaN, Marker=defineModelMarker(3), MarkerFaceColor="none", MarkerEdgeColor="k", LineStyle="none", LineWidth=plot_options.line_width, ...
        DisplayName="temporal");
    ghost_plots(15) = plot(ax, NaN, NaN, Marker=defineModelMarker(5), MarkerFaceColor="none", MarkerEdgeColor="k", LineStyle="none", LineWidth=plot_options.line_width, ...
