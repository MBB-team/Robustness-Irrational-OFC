...
%       - is_rational: see gatherAllModels
%       - is_irrational: see gatherAllModels
%       - value_function_attended_regressor_diff: see
%       computeCueAttentionPollution
%
% i_config : <int 1x1>
...
customViolinplot(ax, ...
    - plot_options.distrib_x_shift, Data.value_function_attended_regressor_diff(Data.is_rational)', ...
...
customViolinplot(ax, ...
    plot_options.distrib_x_shift, Data.value_function_attended_regressor_diff(Data.is_irrational)', ...
    Color=defineModelColor(i_config), ...
    FaceAlpha=0.5, ...
...
for monkey = ["Franck", "Miles"]
    plot(ax, x_monkey, ...
        MonkeyData.(monkey).value_function_attended_regressor_diff * ones(1, length(x_monkey)), ...
...
grad_diff_rational = Data.value_function_attended_regressor_diff(Data.is_rational)';
grad_diff_rational = repmat(grad_diff_rational, 2, 1);
grad_diff_irrational = Data.value_function_attended_regressor_diff(Data.is_irrational)';
